    ...
    >
      <div className="grid gap-2 gap-y-4 pb-[100px] md:pb-0">
        <div className="grid grid-cols-2 gap-x-3 gap-y-3">
          <p className="text-sm">
            Tip utilizator: <br />
            <strong className="capitalize text-medium">Client</strong>
          </p>
          <p className="text-sm">
            Nume de utilizator: <br />
            <strong className="capitalize text-medium">
          ...
          <p className="text-sm">
            ...
            <span className="flex flex-wrap">
              {onboardingDetails.trainingAvailabilityDays?.map((day) => (
                <strong className="capitalize text-medium mr-2" key={day}>
                  {day}
                </strong>
              ))}
            </span>
          ...
          <p className="text-sm">
            ...
            <span className="flex flex-wrap">
              {onboardingDetails.trainingAvailabilityTime?.map((time) => (
                <strong className="capitalize text-medium mr-2" key={time}>
                  {time}
                </strong>
              ))}
            </span>
          ...
          <p className="text-sm">
            ...
            <strong className="capitalize text-medium mr-2">
