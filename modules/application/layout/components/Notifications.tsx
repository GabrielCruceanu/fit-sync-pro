...
export function Notifications() {
  return (
    <Popover placement={"bottom-end"} color="default" backdrop={"blur"}>
      <PopoverTrigger>
        <Button
          color="default"
          variant="light"
      ...
      <PopoverContent className="overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-background">
        ...
        <Link
          href="/notifications"
          className="block p-2 rounded text-md font-medium text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-600 dark:text-white dark:hover:underline"
        >
