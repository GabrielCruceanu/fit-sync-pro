"use client";
import { cn, NavbarMenuToggle } from "@nextui-org/react";
...
export function LayoutNavigation({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="antialiased bg-gray-50 dark:bg-background">
      <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-background dark:border-gray-700 fixed lg:hidden left-0 right-0 top-0 z-50">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex justify-start items-center">
            <Button
              ...
              className="mr-2"
            >
              {drawerNavigation ? <XIcon /> : <HamburgerMenuIcon />}
            </Button>
      ...
      <div className="relative flex h-full w-full flex-1">
        <aside
          className={cn(
            "fixed top-0 left-0 z-40 w-64 h-screen pt-14 lg:pt-0 transition-transform  bg-white border-r border-gray-200 lg:!translate-x-0 dark:bg-background dark:border-gray-700",
        ...
        >
          <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-background">
            <a
              ...
              className="items-center pl-2.5 mb-5 hidden lg:flex"
            >
              <img
          ...
          <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-background z-20">
            <a
              href="#"
        ...
        <main className="dark:bg-background w-full flex-1 p-4 flex flex-col items-stretch h-full space-y-4 lg:mx-64 pt-20 lg:pt-4">
          {/*<div className="border-2 border-dashed border-gray-300 rounded-xl dark:border-gray-600 h-96"></div>*/}
          {children}
        </main>

        <aside
          className="fixed top-0 right-0 z-40 w-64 h-screen pt-20 lg:pt-0 transition-transform translate-x-full bg-white border-l border-gray-200 lg:!translate-x-0 dark:bg-background dark:border-gray-700"
          ...
          <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-background">
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center justify-center">
                ...
                <div
                  className="hidden overflow-hidden w-80 z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                  id="apps-dropdown"
                >
                  <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
                    Apps
                ...
                <div
                  className="hidden overflow-hidden z-50 w-96 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
                ...
                <button
                  ...
                  className="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                >
                  <span className="sr-only">View support dropdown</span>
                ...
                <div
                  className="hidden overflow-hidden z-50 w-64 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
                  id="support-dropdown"
                >
                  <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
                    Support
